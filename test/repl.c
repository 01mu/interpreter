...
void repl_test() {
    char * t[][2] = {
        ...
        {"{\"a\": 1}[\"a\"];", "1 "},
        {"let a = 0; let z = [0]; z[0];", "0 [0] 0 "},
        {"let a = \"a\"; let z = {\"a\": 1}; z[a];", "'a' {'a': 1} 1 "},
        {"let a = fn() { return \"a\"; }; let z = {\"a\": 1}; z[a()]; a(); \
            a();", "{'a': 1} 1 'a' 'a' "},
        {"let z = {\"a\": 1, \"b\": \"z\"}; z[\"a\"]; z[\"b\"];", \
            "{'a': 1, 'b': 'z'} 1 'z' "},
        {"[0,[0,1]][1][1] = 3", "NULL "},
        ...
        {"let a = [1]; push(a, 'a'); push(a, 1); a;",
            "[1] NULL NULL [1, 'a', 1] "},
        // 80 ==================================================================
        {"let a = [1]; let g = fn(a) { return fn() { a[0] = 'a'; \
            return[3]; }(); }; g(a); a;", "[1] NULL [3] ['a'] "},
        {"let a = {'a': z};", "Identifier not found: z "},
        {"let b = 3; let a = [1]; let b = a; b;", "3 [1] [1] [1] "},
        {"let a = [1]; push(fn (x) { return x; }(a), 3); a; push(a, 5); a;",
            "[1] NULL [1] NULL [1, 5] "},
        {"let z = {'a': 'a'}; let d = fn(x) { return z; }(z);",
            "{'a': 'a'} {'a': 'a'} "},
        {"let z = {'a': 1}; fn(x) { let x = 3; }(z); z; ",
            "{'a': 1} 3 NULL 3 "},
        {"let a = {'a': [0]}; a['a'][0] = [[1]]; a;",
            "{'a': [0]} NULL {'a': [[[1]]]} "},
        {"let a = [0, [[1]], 0]; a[1][0][0] = 'z'; a;",
            "[0, [[1]], 0] NULL [0, [['z']], 0] "},
        {"let z = {'a': [1]}; z['a'][0] = 2; z;",
            "{'a': [1]} NULL {'a': [2]} "},
